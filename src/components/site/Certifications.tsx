      ...
      <div className="grid gap-12 lg:grid-cols-[1.1fr_.9fr]">
        <div>
          ...
          {education.map((entry, i) => (
            ...
            >
              <span className="font-mono text-[9px] text-primary">{i === 0 ? "ED" : "TR"} / 0{i + 1}</span>
              <div>
                <p className="mb-2 font-mono text-[8px] uppercase tracking-[.14em] text-muted-foreground">{i === 0 ? "Formal education" : "Professional training"}</p>
            ...
            >
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  ...
                  {cert.verification ? "Verification link available" : "Verification link pending"} · Credential ID pending
                </p>
              </div>
            </motion.div>
          ))}
