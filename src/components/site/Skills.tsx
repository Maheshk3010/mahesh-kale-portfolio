...
const stack = [
  ...
  ["Supporting", "Git · GitHub · Jupyter · VS Code"],
];

export function Skills() {
  return (
    <Section id="skills" eyebrow="Section 05 / Toolchain" title="Analytics stack" description="Tools organized by the work they perform—not by logo or popularity.">
