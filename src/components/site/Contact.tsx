    ...
    <Section id="contact" className="pb-32" navTitle="Contact">
      ...
      >
        ...
        <div className="relative grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
          <motion.div variants={stagger(0.05, 0.08)} initial="hidden" whileInView="visible" viewport={inView}>
            <motion.p variants={revealUp} className="font-mono text-[10px] font-bold uppercase tracking-[.2em] text-primary">
              Final report / Available
            </motion.p>
            <motion.h2 variants={revealUp} className="mt-6 max-w-4xl font-display text-4xl font-bold uppercase leading-[.95] sm:text-6xl">
              Let&apos;s talk <span className="text-primary">data.</span>
            </motion.h2>
            <motion.p variants={revealUp} className="mt-6 max-w-xl text-base leading-7 text-muted-foreground">
              Open to Data Analyst and MIS Executive opportunities.
            </motion.p>
          </motion.div>
          <motion.div variants={stagger(0.18, 0.06)} initial="hidden" whileInView="visible" viewport={inView} className="grid gap-2 sm:grid-cols-2 lg:grid-cols-1">
            ...
            <motion.div variants={revealUp} className="contents">
            <Button variant="outline" size="lg" disabled title="Resume file awaiting verification">
              <Download />
              Download resume
            </Button>
            </motion.div>
