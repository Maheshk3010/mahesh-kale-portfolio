  ...
  return (
    <Section id="contact" className="pb-32" navTitle="Contact">
      <motion.div
        ...
        viewport={{ once: true }}
        className="relative overflow-hidden border border-primary/35 bg-surface p-7 sm:p-10 md:p-14"
      >
        <div className="control-grid pointer-events-none absolute inset-0 opacity-40" />
        <div className="relative grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
          <div>
            <p className="font-mono text-[10px] font-bold uppercase tracking-[.2em] text-primary">
              Final report / Available
            </p>
            <h2 className="mt-6 max-w-4xl font-display text-4xl font-bold uppercase leading-[.95] sm:text-6xl">
